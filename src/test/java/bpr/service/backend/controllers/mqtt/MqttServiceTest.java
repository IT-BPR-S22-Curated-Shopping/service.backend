...
class MqttServiceTest {
    ...
    public void canConnectSunny() throws ExecutionException, InterruptedException {
        ...
        var willMock = Mockito.mock(Mqtt5WillPublishBuilder.Nested.Complete.class, Mockito.RETURNS_DEEP_STUBS);
        ...
        Mockito.when(nestedMock.applySimpleAuth()).thenReturn(willMock);
        Mockito.when(willMock.applyWillPublish()).thenReturn(sendMock);
        ...
        var service = new MqttController(conf, new EventManager());
